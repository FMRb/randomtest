            ...
            function(socket) {
                return {
                    ...
                    link: function(scope, element, attrs) {
                         ...
                         function render() {
                            if(scope.data) {
                                //Remove elment inside container, in order to avoid the duplication of the chart
                                element.empty();
                                ...
                                // Nest posted values by name and date.
                                posts = d3.nest()
                                ...
                                //Parse data and generate array of dates
                                var dateArray = [];
                                posts.forEach(function(s) {
                                    var index = 0;
                                    s.values.forEach(function(d) {
                                ...
                                //posts.sort(function(a, b) { return b.maxPrice - a.maxPrice; });
                                x.domain(d3.extent(dateArray, function(d) { return d.date; }));

                                // Compute the minimum and maximum date across posts.
                                y.domain([
